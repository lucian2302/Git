...
public class MenuPersona implements Comparable<MenuPersona> {
	...
	public MenuPersona(String d, String n, String a, Fecha F) {
		this.dni = d;
		this.nombre = n;
		this.apellidos = a;
	...
	// Constructor Copia
	public MenuPersona(MenuPersona P) {
		this.dni = P.dni;
...
//Getters and Setters
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MenuPersona other = (MenuPersona) obj;
	...
	@Override
	public int compareTo(MenuPersona other) {
