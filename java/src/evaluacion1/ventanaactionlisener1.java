...
public class ventanaactionlisener1 extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ventanaactionlisener1 frame = new ventanaactionlisener1();
