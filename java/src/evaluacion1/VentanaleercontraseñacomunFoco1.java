...
public class VentanaleercontraseñacomunFoco1 extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaleercontraseñacomunFoco1 frame = new VentanaleercontraseñacomunFoco1();
	 ...
	 * Create the frame.
	 */
	public VentanaleercontraseñacomunFoco1() {
		setResizable (false);
		setTitle("Hola");
	...
	//contraseña
		...
		passwordField.addFocusListener(new FocusAdapter() {
			...
			public void focusGained(FocusEvent e) {
				passwordField.select(0, passwordField.getText().length());
			}
			@Override
			public void focusLost(FocusEvent e) {
