...
public class ventana_area_perimetro_cuadrado extends JFrame implements ActionListener {
	...
	public static void main (String[] args) 	{
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ventana_area_perimetro_cuadrado frame = new ventana_area_perimetro_cuadrado();
	 ...
	 * Create the frame.
	 */
	public ventana_area_perimetro_cuadrado() {
	 ...
	 gl_contentPane = new GroupLayout(contentPane);
		...
		lblFormula_1 = new JLabel("Formula : Lado * 4");
	  ...
	  panel = new JPanel();
		...
		lblFormulaBase = new JLabel("Formula : Base * Altura");
